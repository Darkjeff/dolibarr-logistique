...
/**
 * \defgroup    logistique    Logistique module
 * \brief       Logistique module descriptor.
 *
 * Put detailed description here.
 */

/**
 * \file        core/modules/modLogistique.class.php
 * \ingroup     logistique
...
/**
 * Description and activation class for module Logistique
 */
class modLogistique extends DolibarrModules
{
	...
	public $rights_class = 'logistique';
...
//        )
	...
	public $name = "LOGISTIQUE";

	/** @var string Module short description */
	public $description = "Description of module Logistique";
	...
	public $const_name = 'MAIN_MODULE_LOGISTIQUE';

	/**
	 * @var string Module logo
	 * Should be named object_logistique.png and store under logistique/img
	 */
	public $picto = 'logistique@logistique';

	/** @var array Define module parts */
	public $module_parts = array(
		/** @var bool Module ships triggers in logistique/core/triggers */
		'triggers' => false,
		/**
		 * @var bool Module ships login in logistique/core/login
		 * @todo: example
		 */
		'login' => false,
		/**
		...
		'menus' => false,
		/**
		 * @var bool Module ships theme in logistique/theme
		 * @todo example
		 */
		'theme' => false,
		/**
		 * @var bool Module shipped templates in logistique/core/tpl overload core ones
		 * @todo example
		 */
		'tpl' => false,
		/**
	...
	public $config_page_url = 'setup.php@logistique';
	...
	public $langfiles = array('logistique@logistique');
	...
	public function __construct($db)
	{
		...
		// Example:
		$this->tabs = array(
		'invoice:+tabname1:LOGISTIQUE:$user->rights->logistique->read:/logistique/logistique.php?id=__ID__',
		'propal:+tabname1:LOGISTIQUE:$user->rights->logistique->read:/logistique/logistiqueprop.php?id=__ID__',
		);
		...
		// Dictionaries
		if (! isset($conf->logistique->enabled)) {
			$conf->logistique=new stdClass();
			$conf->logistique->enabled = 0;
		}
		$this->dictionaries = array();
		// Example:
		$this->dictionaries=array(
		  'langs'=>'logistique@logistique',
		);
		...
		//Menu's title. FIXME: use a translation key
			'titre'=>'Logistique top menu',
		//This menu's mainmenu ID
			'mainmenu'=>'logistique',
		//This menu's leftmenu ID
			'leftmenu'=>'logistique',
			'url'=>'/logistique/index.php',
			// Lang file to use (without .lang) by module.
			// File must be in langs/code_CODE/ directory.
			'langs'=>'mylangfile',
			'position'=>100,
			// Define condition to show or hide menu entry.
			// Use '$conf->logistique->enabled' if entry must be visible if module is enabled.
			'enabled'=>'$conf->logistique->enabled',
			// Use 'perms'=>'$user->rights->logistique->level1->level2'
		...
		//	'type'=>'left',
		// Menu's title. FIXME: use a translation key
		//	'titre'=>'Logistique left menu',
		// This menu's mainmenu ID
		//	'mainmenu'=>'mainmenucode',
		// This menu's leftmenu ID
		//	'leftmenu'=>'logistique',
		//	'url'=>'/logistique/pagelevel2.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
	 ...
	 * and create data commands must be stored in directory /logistique/sql/
	...
	{
		return $this->_load_tables('/logistique/sql/');
	}
